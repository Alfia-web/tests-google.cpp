...
TEST(mulDiv, ассоциативностьУмножения) {
    bool error = false;
    int position = 0;
...
TEST(mulDiv, ассоциативностьДеления) {
    bool error = false;
    int position = 0;
...
TEST(mulDiv, смешанноеВыражение) {
    bool error = false;
    int position = 0;
